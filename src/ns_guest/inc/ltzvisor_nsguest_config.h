...
struct nsguest_conf_entry {
	...
	char_tee gce_name[30];
	uint32_tee gce_id;
	/* Initial Ram Disk info */
	uint32_tee gce_trd_init;
	uint32_tee gce_trd_start;
	uint32_tee gce_trd_end;
	uint32_tee gce_trd_load;
	/* Binary info */
	uint32_tee gce_bin_start;
	uint32_tee gce_bin_end;
	uint32_tee gce_bin_load;
};
